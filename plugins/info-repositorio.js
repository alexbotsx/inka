...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://api.github.com/repos/BrunoSobrino/𝗦𝗔𝗣𝗜𝗧𝗢 𝗕𝗢𝗧');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://www.instagram.com/yaritza.dzn05?igsh=MXg2dWhjdTV0eWxvaQ=='}_`;
